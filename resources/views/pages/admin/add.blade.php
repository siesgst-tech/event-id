        ...
        <div class="col col-xs-12 col-sm-10 col-sm-offset-1 col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4">
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="about" id="about" placeholder="About">{{ old('about') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="rules" id="rules" placeholder="Rules of this event...">{{ old('rules') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="gameplay" id="gameplay" placeholder="How to play this event...">{{ old('gameplay') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="eventhead" id="eventhead" placeholder="Event Heads and their contact">{{ old('eventhead') }}</textarea>
                    @if($errors->has('eventhead'))<span class="help-block error">{{ $errors->first('eventhead') }}</span>@endif
                </div>
                <div class="form-group">
                    <label for="cost" class="control-label">Cost</label>
                    <input type="number" class="form-control" name="cost" id="cost" placeholder="Cost" {{ old('cost') }}>
